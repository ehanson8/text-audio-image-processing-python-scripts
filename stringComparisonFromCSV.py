...
parser.add_argument('-f', '--fileName', help='the CSV file of headings. \
optional - if not provided, the script will ask for input')
parser.add_argument('-c', '--columnName', help='the name of the column in the \
CSV file containing the strings to be compared. optional - if not provided, \
...
if args.fileName:
    ...
    fileName = input('Enter the file name of the CSV of headings \
    (including \'.csv\'): ')
if args.columnName:
    columnName = args.columnName
else:
    columnName = input('Enter the name of the column in the CSV file \
    containing the strings to be compared: ')
if args.threshold:
